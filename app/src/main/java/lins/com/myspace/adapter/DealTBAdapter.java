 ...
 * Please Try Hard
 */
public class DealTBAdapter extends RecyclerView.Adapter<DealTBAdapter.MsgViewHolder>{
    ...
    public DealTBAdapter(Context context, List<TextBoxInfo> datas){
    ...
    public MsgViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_deal_textbox,parent,false);
    ...
    public void delData(TextBoxInfo textBoxInfo){
        TextBoxManager.deleteById(textBoxInfo);
        this.mDatas = TextBoxManager.query();
        //notifyDataSetChanged();
    }
    ...
    class MsgViewHolder extends RecyclerView.ViewHolder{
        ...
        public MsgViewHolder(View v) {
            super(v);
            tv = (TextView) v.findViewById(R.id.tv_deal_textbox);
        }
    }
}

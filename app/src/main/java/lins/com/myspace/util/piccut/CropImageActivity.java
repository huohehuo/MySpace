package lins.com.myspace.util.piccut;
...
public class CropImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.top_bar).findViewById(R.id.tv_top_title)).setText("裁剪图片");
        TextView ok= (TextView) findViewById(R.id.top_bar).findViewById(R.id.tv_top_right);
        ok.setTextColor(getResources().getColor(R.color.bg));
        ok.setText("完成");
